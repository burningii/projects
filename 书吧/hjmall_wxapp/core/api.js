...
var api = {
    ...
    rechargeOrder: {
        get_recharge_type: _api_root + "recharge-order/get-recharge-type",
        order_submit: _api_root + "recharge-order/order-submit",
        pay_data: _api_root + "recharge-order/pay-data"
    },
    sign_order:{
        pre_sign: _api_root + "sign-order/pre-sign",
        sign: _api_root + "sign-order/sign",
        sign_off: _api_root + "sign-order/sign-off",
        my_sign: _api_root + "sign-order/my-sign",
        get_qrcode: _api_root + "sign-order/get-qrcode",
        sign_order: _api_root + "sign-order/sign-order"
    },
    common: {
        get_seats: _api_root + "common/get-seats"
    },
    default: {
        sms: _api_root + "default/sms",
        check_sms: _api_root + "default/check-sms",
    ...
    user: {
        binding: _api_root + "user/binding",
