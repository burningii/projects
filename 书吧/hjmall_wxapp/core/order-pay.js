                        ...
                        0 == e.code && (setOnShowScene("pay"), getApp().core.requestPayment({
                            ...
                            complete: function(e) {
                                "requestPayment:fail" != e.errMsg && "requestPayment:fail cancel" != e.errMsg ? getApp().core.redirectTo({
                                    url: "/" + o + "?status=1"
                                    // url: `/pages/selectOrderTime/selectOrderTime?seatName=${seatname.seatName}&seatId=${seatname.seatId}`
                                ...
                                success: function(e) {
                                    if (0 != e.code) {
                                        ...
                                        setTimeout(function() {
                                            ...
                                            fail: function(e) {},
                                            complete: function(e) {
                                                let seatname = wx.getStorageSync('seat_info');
                                                "requestPayment:fail" != e.errMsg && "requestPayment:fail cancel" != e.errMsg ? "requestPayment:ok" != e.errMsg || (void 0 !== _.page.data.goods_card_list && 0 < _.page.data.goods_card_list.length ? _.page.setData({
                                                    ...
                                                    // url: u + "?status=1"
                                                    url: `/pages/selectOrderTime/selectOrderTime?seatName=${seatname.seatName}&seatId=${seatname.seatId}&storeName=${seatname.storeName}&storeImg=${seatname.storeImg}`
                                                })) : getApp().core.showModal({
                                                    title: "提示",
                                                    content: "订单尚未支付",
                                                    showCancel: !1,
