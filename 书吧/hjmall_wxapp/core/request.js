module.exports = function (a) {
    a.data || (a.data = {});
    var o = this.core, e = this.core.getStorageSync(this.const.ACCESS_TOKEN),
    ...
    t && 1 <= t.length && s.is_form_id_request && (s.is_form_id_request = !1, s.request({
        ...
        success: function (e) {
            ...
            // -1 == e.data.code ? (s.core.hideLoading(), s.is_login = !1) : -2 == e.data.code ? o.redirectTo({
            //     url: "/pages/store-disabled/store-disabled"
            // }) :
            -1 == e.data.code ? (s.core.hideLoading(), s.is_login = !1) : ""
